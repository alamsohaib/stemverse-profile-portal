...
const JoinFamilyCallout = () => (
  <section className="w-full flex justify-center px-4">
    <div className="w-full flex flex-col items-center bg-gradient-to-br from-yellow-50 via-blue-50 to-white rounded-3xl shadow-2xl border border-primary/30 p-8 gap-3 text-center animate-fade-in relative overflow-hidden">
      
      <div className="relative z-10">
        <span className="text-xl font-bold text-stemblue mb-1 flex items-center justify-center gap-2">
