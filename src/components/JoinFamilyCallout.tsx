...
const JoinFamilyCallout = () => (
  <section className="w-full flex justify-center my-10 px-4">
    <div className="w-full flex flex-col items-center bg-gradient-to-br from-primary/90 via-space-purple/80 to-space-blue/90 rounded-3xl shadow-2xl border border-primary/30 p-8 gap-3 text-center animate-fade-in relative overflow-hidden">
