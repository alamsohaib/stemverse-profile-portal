	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				stemblue: {
					DEFAULT: "#263868" // STEM blue accent
				},
				// Space theme colors
				space: {
        ...
        "rocket-launch": {
          ...
          "100%": { transform: "translateY(-60px) rotate(0deg)", opacity: "0.6" }
        },
        "glow": {
        ...
        'fade-in': 'fade-in 0.7s cubic-bezier(0.1, 0.6, 0.4, 1)',
        'scale-in': 'scale-in 0.3s cubic-bezier(0.1,0.6,0.4,1)',
        // Space animations
        'float': 'float 6s ease-in-out infinite',
        'orbit': 'orbit 20s linear infinite',
        'rocket-launch': 'rocket-launch 3s ease-in-out infinite',
